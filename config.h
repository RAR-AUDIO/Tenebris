#define PLUG_NAME "Tenebris"
#define PLUG_MFR "RAR-AUDIO"
#define PLUG_VERSION_HEX 0x00000100
#define PLUG_VERSION_STR "1.0.0"
#define PLUG_UNIQUE_ID 'qOKl'
#define PLUG_MFR_ID 'Rara'
#define PLUG_URL_STR "https://raraudio.net"
#define PLUG_EMAIL_STR "spam@me.com"
#define PLUG_COPYRIGHT_STR "Copyright 2021 RAR-AUDIO"
#define PLUG_CLASS_NAME Tenebris

#define BUNDLE_NAME "Tenebris"
#define BUNDLE_MFR "RAR-AUDIO"
#define BUNDLE_DOMAIN "net"

#define SHARED_RESOURCES_SUBPATH "Tenebris"
...
#define PLUG_WIDTH 890
#define PLUG_HEIGHT 330
#define PLUG_FPS 60
#define PLUG_SHARED_RESOURCES 0
#define PLUG_HOST_RESIZE 0

#define AUV2_ENTRY Tenebris_Entry
#define AUV2_ENTRY_STR "Tenebris_Entry"
#define AUV2_FACTORY Tenebris_Factory
#define AUV2_VIEW_CLASS Tenebris_View
#define AUV2_VIEW_CLASS_STR "Tenebris_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "Tenebris\nIPEF"
...
#define LOGO_FN "Misc/logowoBackground.png" // Logo

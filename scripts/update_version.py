...
def main():
  ...
  plistpath = scriptpath + "/resources/Tenebris-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tenebris-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tenebris-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tenebris-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tenebris-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Tenebris.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Tenebris.iss",inplace=1):

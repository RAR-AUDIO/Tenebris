...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Tenebris Demo Installer\n"
      else:
        line="OutputBaseFilename=Tenebris Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Tenebris Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Tenebris installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Tenebris Demo installer\n"
     else:
       line="SetupWindowTitle=Tenebris installer\n"
